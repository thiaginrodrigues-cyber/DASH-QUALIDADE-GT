...
function S3e() {
  const [e, t] = A.useState(() => {
    ...
    O = A.useCallback(async (Q) => {
      ...
      const sheetGroups = [
        { keywords: ["AVARIA", "AVARIAS", "AVAR", "PERDAS", "QUEBRAS"], status: "AVARIA" },
        { keywords: ["RECUPERADOS", "RECUPERADO", "RECUPERA"], status: "RECUPERADO" },
        { keywords: ["DESCARTE", "DESCARTES", "DESCARTA", "BAIXA", "BAIXAS"], status: "DESCARTE" },
      ];
